...
DoWhileStatement.prototype.compile = function(out) {
	...
	var test = expressions.buildExpression(this.expressionNode, this.context, {resultIsUsed: true});
...
ExpressionStatement.prototype.compile = function(out) {
	var expr = expressions.buildExpression(this.expressionNode, this.context, {resultIsUsed: false});
...
ForStatement.prototype.compile = function(out) {
	...
	if (this.initStatementNode.type == 'ExpressionStatement') {
		...
		init = expressions.buildExpression(initExpressionNode, this.context, {resultIsUsed: false}).compile();
	...
	if (this.testStatementNode.type == 'ExpressionStatement') {
		...
		var testExpression = expressions.buildExpression(testExpressionNode, this.context, {resultIsUsed: true});
	...
	if (this.updateExpressionNode === null) {
		...
		update = expressions.buildExpression(this.updateExpressionNode, this.context, {resultIsUsed: false}).compile();
	}
...
IfStatement.prototype.compile = function(out) {
	var test = expressions.buildExpression(this.testExpressionNode, this.context, {resultIsUsed: true});
...
ReturnStatement.prototype.compile = function(out) {
	...
	if (this.expressionNode === null) {
		...
		var expr = expressions.buildExpression(this.expressionNode, this.context, {resultIsUsed: true});
...
function VariableDeclarator(node, varType, context) {
	...
	if (node.params[1] === null) {
		...
		this.initialValue = expressions.buildExpression(node.params[1], context, {resultIsUsed: true});
